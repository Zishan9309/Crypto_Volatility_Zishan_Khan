...
def main():
    ...
    with tab_about:
        ...
        st.markdown("""<ul class="white-bullets">
            <li><b>Market Monitor:</b> Live price updates and risk status[cite: 17, 19].</li>
            <li><b>Trend Analysis:</b> 7-Day movement helps you spot price patterns[cite: 32, 102].</li>
            <li><b>Volume Demand:</b> Shows the "interest" level of other traders[cite: 8, 24].</li>
            <li><b>Sentiment:</b> Provides a combined "Confidence Score" for the asset[cite: 20, 39].</li>
    ...
    with tab_contact:
        st.markdown("""<div class="insight-box" style="border-left-color: #ffffff;">
            ...
            For technical issues or API integration queries, please reach out to the project lead[cite: 223].<br>
    ...
    with tab_milestone:
        st.markdown("""<div class="insight-box" style="border-left-color: #06d6a0;">
            ...
            ✅ <b>Milestone 1:</b> Data Acquisition & Local Storage[cite: 41, 45].<br>
            ⏳ <b>Milestone 2:</b> Statistical Measures (Sharpe/Beta)[cite: 93, 100, 101].<br>
            ⏳ <b>Milestone 3:</b> Interactive Analytical Dashboard[cite: 151, 154].
        </div>""", unsafe_allow_html=True)
