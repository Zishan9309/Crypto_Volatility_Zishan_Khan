...
def main():
    ...
    <style>
        ...
        div[data-testid="stSelectbox"] label p { color: white !important; font-weight: 600 !important; }
    ...
    with tab_home:
        ...
        # [cite_start]KPI ROW [cite: 103, 229]
        ...
        # [cite_start]---------------- CHARTS SECTION [cite: 16, 17] ----------------
        ...
        with col_a:
            ...
            if coin_obj and 'sparkline_in_7d' in coin_obj:
                ...
                # [cite_start]Price Line Chart [cite: 32, 102]
                fig_t = go.Figure()
                ...
                # [cite_start]Volume Bar Chart [cite: 8, 24]
        ...
        with col_b:
            # [cite_start]Pie Chart [cite: 156, 180]
            ...
            # [cite_start]Insight Box [cite: 20, 39]
    ...
    with tab_about:
        ...
        [cite_start]with info_col1: st.markdown('<div class="insight-box" style="height:220px;"><b style="color:#4cc9f0; font-size:18px;">💎 What is Crypto?</b><br><br>Digital or virtual currencies secured by cryptography[cite: 8]. [cite_start]They operate on decentralized networks called Blockchains[cite: 8].</div>', unsafe_allow_html=True)
        [cite_start]with info_col2: st.markdown('<div class="insight-box" style="height:220px; border-left-color:#ffd166;"><b style="color:#ffd166; font-size:18px;">📉 What is Volatility?</b><br><br>A measure of price swings over time[cite: 7]. [cite_start]High volatility equates to high potential reward but increased risk[cite: 10, 21].</div>', unsafe_allow_html=True)
        [cite_start]with info_col3: st.markdown('<div class="insight-box" style="height:220px; border-left-color:#ef476f;"><b style="color:#ef476f; font-size:18px;">🛡️ What is Risk?</b><br><br>The probability of losing an investment[cite: 7][cite_start], measured via statistical metrics like Sharpe and Beta[cite: 8, 31].</div>', unsafe_allow_html=True)
        st.write("---")
