...
def main():
    ...
    <style>
        ...
        /* Force Full Width for Tab Content */
        ...
        /* About Section White Text Classes */
        .white-edu-text {
            color: #ffffff !important;
            font-size: 16px;
            line-height: 1.6;
    ...
    # ---------------- NAVBAR SECTION ----------------
    # Column layout adjusted for full width look
    ...
    with tab_about:
        ...
        # Three Knowledge Pillars (Knowledge Cards)
        info_col1, info_col2, info_col3 = st.columns(3)
        with info_col1:
            st.markdown('<div class="insight-box" style="height:220px;"><b style="color:#4cc9f0; font-size:18px;">💎 What is Crypto?</b><br><br>Digital or virtual currencies secured by cryptography. They operate on decentralized networks called Blockchains.</div>', unsafe_allow_html=True)
        with info_col2:
            st.markdown('<div class="insight-box" style="height:220px; border-left-color:#ffd166;"><b style="color:#ffd166; font-size:18px;">📉 What is Volatility?</b><br><br>A measure of how much an asset\'s price "swings" over time. High volatility means high potential profit, but also high risk.</div>', unsafe_allow_html=True)
        with info_col3:
            st.markdown('<div class="insight-box" style="height:220px; border-left-color:#ef476f;"><b style="color:#ef476f; font-size:18px;">🛡️ What is Risk?</b><br><br>The probability of losing your investment. We calculate this using <b>Beta</b> and <b>Sharpe Ratios</b> to help you stay safe.</div>', unsafe_allow_html=True)
        ...
        about_table = f"""
        <div style="background:#1b263b; padding:20px; border-radius:12px; border:1px solid #415a77; width:100%;">
            <table style="width:100%; border-collapse:collapse; color:white; font-family:sans-serif;">
                <thead>
                    <tr style="background:#4cc9f0; color:#0d1b2a; text-align:left;">
                        ...
                        <th style="padding:15px;">VOLATILITY</th>
                        <th style="padding:15px;">INVESTOR TYPE</th>
                        <th style="padding:15px;">TYPICAL ASSET</th>
                    </tr>
                </thead>
                <tbody>
                    <tr style="border-bottom: 1px solid #415a77;">
                        <td style="padding:15px; color:#06d6a0; font-weight:bold;">Low Risk</td>
                        <td style="padding:15px;">Stable (0-2%)</td>
                        <td style="padding:15px;">Conservative</td>
                        <td style="padding:15px;">Stablecoins / BTC</td>
                    </tr>
                    <tr style="border-bottom: 1px solid #415a77;">
                        <td style="padding:15px; color:#ffd166; font-weight:bold;">Medium Risk</td>
                        <td style="padding:15px;">Moderate (2-5%)</td>
                        <td style="padding:15px;">Growth-Oriented</td>
                        <td style="padding:15px;">ETH / Top 10 Alts</td>
                    </tr>
                    <tr>
                        <td style="padding:15px; color:#ef476f; font-weight:bold;">High Risk</td>
                        <td style="padding:15px;">Extreme (5%+)</td>
                        <td style="padding:15px;">Speculative</td>
                        <td style="padding:15px;">Meme coins / New tokens</td>
                    </tr>
                </tbody>
            </table>
        </div>
        ...
        # Full Width Interactive Guide with White Bullets
        st.write("")
        st.markdown("<h3 style='color:white;'>🔍 How to read our Dashboard</h3>", unsafe_allow_html=True)
        st.markdown(f"""
        <ul class="white-bullets">
            <li>[cite_start]<b>Market Monitor:</b> Live price updates and risk status[cite: 17, 19].</li>
            <li>[cite_start]<b>Trend Analysis:</b> 7-Day movement helps you spot price patterns[cite: 32, 102].</li>
            <li>[cite_start]<b>Volume Demand:</b> Shows the "interest" level of other traders[cite: 8, 24].</li>
            <li>[cite_start]<b>Sentiment:</b> Provides a combined "Confidence Score" for the asset[cite: 20, 39].</li>
        </ul>
        """, unsafe_allow_html=True)
