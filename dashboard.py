...
def main():
    ...
    st.markdown("""
    <style>
        /* Force the entire app to use full available width */
        .block-container {
        ...
        /* Force Tabs to take full width and start from left */
        ...
        /* TAB STYLING: Full width alignment */
        ...
        /* White color for the Educational Text */
        .white-edu-text {
            color: #ffffff !important;
            font-size: 16px;
            margin-bottom: 20px;
        ...
        /* Styling for White Bullet Points */
        .white-bullets li {
            color: #ffffff !important;
            margin-bottom: 12px;
        }
    ...
    # ---------------- NAVBAR (FULL WIDTH) ----------------
    # Changed from columns to a single container to force left-to-right alignment
    ...
    with tab_about:
        ...
        with info_col1: st.markdown('<div class="insight-box" style="height:220px;"><b style="color:#4cc9f0; font-size:18px;">💎 What is Crypto?</b><br><br>Digital currencies secured by cryptography. [cite_start]They operate on decentralized networks called Blockchains. [cite: 7, 13]</div>', unsafe_allow_html=True)
        [cite_start]with info_col2: st.markdown('<div class="insight-box" style="height:220px; border-left-color:#ffd166;"><b style="color:#ffd166; font-size:18px;">📉 What is Volatility?</b><br><br>A measure of price swings over time. High volatility equates to high potential reward but increased risk. [cite: 7, 99]</div>', unsafe_allow_html=True)
        [cite_start]with info_col3: st.markdown('<div class="insight-box" style="height:220px; border-left-color:#ef476f;"><b style="color:#ef476f; font-size:18px;">🛡️ What is Risk?</b><br><br>The probability of losing an investment, measured via statistical metrics like Sharpe and Beta. [cite: 15, 100, 101]</div>', unsafe_allow_html=True)

        st.write("---")
        st.markdown("<h3 style='color:white;'>📊 Risk-Level Comparison Table</h3>", unsafe_allow_html=True)
        [cite_start]about_table = f"""<div style="background:#1b263b; padding:20px; border-radius:12px; border:1px solid #415a77; width:100%;"><table style="width:100%; border-collapse:collapse; color:white; font-family:sans-serif;"><thead><tr style="background:#4cc9f0; color:#0d1b2a; text-align:left;"><th style="padding:15px;">CATEGORY</th><th style="padding:15px;">VOLATILITY</th><th style="padding:15px;">INVESTOR TYPE</th><th style="padding:15px;">TYPICAL ASSET</th></tr></thead><tbody><tr style="border-bottom: 1px solid #415a77;"><td style="padding:15px; color:#06d6a0; font-weight:bold;">Low Risk [cite: 19][cite_start]</td><td style="padding:15px;">Stable (0-2%)</td><td style="padding:15px;">Conservative</td><td style="padding:15px;">Stablecoins / BTC</td></tr><tr style="border-bottom: 1px solid #415a77;"><td style="padding:15px; color:#ffd166; font-weight:bold;">Medium Risk [cite: 19][cite_start]</td><td style="padding:15px;">Moderate (2-5%)</td><td style="padding:15px;">Growth-Oriented</td><td style="padding:15px;">ETH / Top 10 Alts</td></tr><tr><td style="padding:15px; color:#ef476f; font-weight:bold;">High Risk [cite: 19]</td><td style="padding:15px;">Extreme (5%+)</td><td style="padding:15px;">Speculative</td><td style="padding:15px;">Meme coins / New tokens</td></tr></tbody></table></div>"""
        ...
        [cite_start]st.markdown("""<ul class="white-bullets"><li><b>Market Monitor:</b> Live price updates and risk status [cite: 17, 19][cite_start].</li><li><b>Trend Analysis:</b> 7-Day movement helps you spot price patterns [cite: 32, 102][cite_start].</li><li><b>Volume Demand:</b> Shows the "interest" level of other traders [cite: 8, 24][cite_start].</li><li><b>Sentiment:</b> Provides a combined "Confidence Score" for the asset[cite: 20, 39].</li></ul>""", unsafe_allow_html=True)

    with tab_contact:
        [cite_start]st.markdown(f"""<div class="insight-box" style="border-left-color: #ffffff;"><b style="color:#4cc9f0; font-size:20px;">DEVELOPER SUPPORT</b><br><br>For technical issues or API integration queries, please reach out to the project lead[cite: 223].<br><b>Location:</b> Nagpur, MH | [cite_start]<b>System:</b> AI-Driven Risk Analysis [cite: 10]</div>""", unsafe_allow_html=True)

    with tab_milestone:
        [cite_start]st.markdown(f"""<div class="insight-box" style="border-left-color: #06d6a0;"><b style="color:#4cc9f0; font-size:20px;">CURRENT PROGRESS</b><br><br>✅ <b>Milestone 1:</b> Data Acquisition & Local Storage [cite: 41, 45][cite_start].<br>⏳ <b>Milestone 2:</b> Statistical Measures (Sharpe/Beta) [cite: 93, 100, 101][cite_start].<br>⏳ <b>Milestone 3:</b> Interactive Analytical Dashboard[cite: 151, 154].</div>""", unsafe_allow_html=True)
