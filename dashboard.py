...
def main():
    ...
    st.markdown("""
    <style>
        /* FORCE FULL WIDTH: Removes the right-side only alignment */
        .block-container {
        ...
        /* Force Tab Panel to occupy 100% width */
    ...
    with tab_about:
        ...
        with info_col1: st.markdown('<div class="insight-box" style="height:220px;"><b style="color:#4cc9f0; font-size:18px;">💎 What is Crypto?</b><br><br>Digital or virtual currencies secured by cryptography. They operate on decentralized networks called Blockchains.</div>', unsafe_allow_html=True)
        ...
        about_table = f"""<div style="background:#1b263b; padding:20px; border-radius:12px; border:1px solid #415a77; width:100%;"><table style="width:100%; border-collapse:collapse; color:white; font-family:sans-serif;"><thead><tr style="background:#4cc9f0; color:#0d1b2a; text-align:left;"><th style="padding:15px;">CATEGORY</th><th style="padding:15px;">VOLATILITY</th><th style="padding:15px;">INVESTOR TYPE</th><th style="padding:15px;">TYPICAL ASSET</th></tr></thead><tbody><tr style="border-bottom: 1px solid #415a77;"><td style="padding:15px; color:#06d6a0;">Low Risk</td><td style="padding:15px;">Stable (0-2%)</td><td style="padding:15px;">Conservative</td><td style="padding:15px;">Stablecoins</td></tr><tr style="border-bottom: 1px solid #415a77;"><td style="padding:15px; color:#ffd166;">Medium Risk</td><td style="padding:15px;">Moderate (2-5%)</td><td style="padding:15px;">Growth-Oriented</td><td style="padding:15px;">ETH</td></tr><tr><td style="padding:15px; color:#ef476f;">High Risk</td><td style="padding:15px;">Extreme (5%+)</td><td style="padding:15px;">Speculative</td><td style="padding:15px;">Meme coins</td></tr></tbody></table></div>"""
        ...
        st.markdown("""<ul class="white-bullets">
            ...
            <li><b>Volume Demand:</b> Shows the "interest" level of traders.</li>
    ...
    with tab_contact:
        st.markdown("""<div class="insight-box" style="border-left-color: #ffffff;">
            ...
            For technical issues or API integration queries, please reach out to the project lead.<br>
    ...
    with tab_milestone:
        st.markdown("""<div class="insight-box" style="border-left-color: #06d6a0;">
            ...
            ✅ <b>Milestone 1:</b> Data Acquisition & Local Storage.<br>
            ⏳ <b>Milestone 2:</b> Statistical Measures (Sharpe/Beta).<br>
            ⏳ <b>Milestone 3:</b> Interactive Analytical Dashboard.
        </div>""", unsafe_allow_html=True)
